                ...
                <tr>
                    ...
                    <td>
						...
						echo sprintf(__('<ol id="%1$s">
							...
							<li>Ensure <a href="%3$s" class="components-external-link" target="_blank">Places API</a> is enabled in your account;</li>
                        ...
                        </ol>', 'g-business-reviews-rating'), 'welcome-google-credentials-steps', 'https://console.developers.google.com/apis/credentials', 'https://console.cloud.google.com/apis/library/places-backend.googleapis.com?q=place', 'https://console.developers.google.com/apis/credentials', $this->server_ip()); ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <p class="input">
                            <input type="text" id="welcome-place-id" class="regular-text code" name="google_business_reviews_rating_place_id" placeholder="<?php echo esc_attr(str_repeat('x', 26)); ?>" value="<?php echo esc_attr(get_option('google_business_reviews_rating_place_id')); ?>">
...
?>
                        ...
                        <p id="welcome-update-billing" class="description"<?php echo (get_option('google_business_reviews_rating_update') == NULL) ? ' style="display: none;"' : ''; ?>><?php /* translators: %s: refers to a the Google billing account URL */
						echo sprintf(__('Please <a href="%s" class="components-external-link" target="_blank">enable billing</a> to receive your substantial and <em>free</em> API request allocation.', 'g-business-reviews-rating'), 'https://console.cloud.google.com/project/_/billing/enable'); ?></p>
                    </td>
                </tr>
            </table>
...
?>
                        ...
                        <p id="update-billing" class="description"<?php echo (get_option('google_business_reviews_rating_update') == NULL) ? ' style="display: none;"' : ''; ?>><?php /* translators: %s: refers to a the Google billing account URL */
						echo sprintf(__('Please <a href="%s" class="components-external-link" target="_blank">enable billing</a> to receive your substantial and <em>free</em> API request allocation.', 'g-business-reviews-rating'), 'https://console.cloud.google.com/project/_/billing/enable'); ?></p>
                    </td>
                </tr>
                <tr>
      ...
      <form method="post" action="options.php" id="google-business-reviews-rating-shortcodes">
            ...
            <table class="wp-list-table widefat fixed striped parameters">
                ...
                <tr id="parameter-id">
                    ...
                    <td class="description"><?php _e('Select one or more reviews by their ID (see Reviews). Ordering is maintained when a comma separated listed is set; enclose in quotes for two or more IDs.', 'g-business-reviews-rating'); ?></td>
                ...
                <tr id="parameter-name">
                    ...
                    <td class="accepted">yes, no, true, false, <span class="code">1</span>, <span class="code">0</span>, show, hide, on, off, <em><?php esc_html_e('Any string'); ?></em></td>
                    <td class="default"><span class="code">TRUE</span></td>
                    <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                    <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                </tr>
                ...
                <tr id="parameter-stars">
                    ...
                    <td class="accepted">svg, html, css, yes, no, true, false, show, hide, on, off, <em><?php esc_html_e('Any valid color string'); ?></em></td>
                ...
                <tr id="parameter-stars-gray">
                    ...
                    <td class="accepted"><span class="code">NULL</span>, css, <em><?php esc_html_e('Any valid color string'); ?></em></td>
                    <td class="default"><span class="code">NULL</span></td>
                    <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                    <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                </tr>
                ...
                <tr id="parameter-review-word">
                    ...
                    <td class="description"><?php /* translators: Please keep reference to &#37;u intact, example in alternative language preferred */ _e('Word displayed after the total review/rating count number in the summary. Accepts &#37;u to set placement of review/rating count (e.g. <em>Tenemos &#37;u comentarios</em>). For completeness, you may separate singular and plural with , or / characters.', 'g-business-reviews-rating'); ?></td>
                ...
                <tr id="parameter-review-text-inc">
                    ...
                    <td class="accepted">excellent or &quot;good, superb, great, &hellip;&quot;, <em><?php esc_html_e('Any string'); ?></em></td>
                    <td class="default"><span class="code">NULL</span></td>
                    <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                    <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                </tr>
                <tr id="parameter-review-text-exc">
                    ...
                    <td class="accepted">poor or &quot;average, bad, avoid, &hellip;&quot;, <em><?php esc_html_e('Any string'); ?></em></td>
                    <td class="default"><span class="code">NULL</span></td>
                    <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                    <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                </tr>
                ...
                <tr id="parameter-date">
                    ...
                    <td class="accepted">relative, no, false, <span class="code">0</span>, hide, off, <em><?php esc_html_e('Any valid string'); ?></em></td>
                ...
                <tr id="parameter-link">
                    ...
                    <td class="accepted">reviews, &quot;write review&quot;, yes, no, true, false, <span class="code">1</span>, <span class="code">0</span>, <em><?php esc_html_e('URL string'); ?></em></td>
                ...
                <tr id="parameter-avatar">
                    ...
                    <td class="accepted">yes, no, true, false, <span class="code">1</span>, <span class="code">0</span>, show, hide, on, off, <em><?php /* translators: example path to image, include forward slashes */ esc_html_e('/url/to/image.jpg'); ?></em></td>
                    <td class="default"><span class="code">TRUE</span></td>
                    <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                    <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                </tr>
                ...
                <tr id="parameter-target">
                    ...
                    <td class="accepted"><span class="code">NULL</span>, <em><?php esc_html_e('Any valid string'); ?></em></td>
                ...
                <tr id="parameter-multiplier">
                    ...
                    <td class="accepted"><em><?php esc_html_e('Positive float number:'); ?></em> <span class="code">0.001</span> &ndash; <span class="code">10</span></td>
...
<?php /* translators: 1: plugin support URL, 2: author's name, 3: author's website, 4: author's business name */ 
	echo sprintf(__('			<p>This little plugin came about as a side-effect to collecting a business&rsquo;s opening times using data from a client&rsquo;s Google My Business listing. The recent review data is available and, with some tweaks, it could be displayed anywhere in a similar style to the actual Google review popup.</p>
